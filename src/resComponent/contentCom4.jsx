    ...
    return (
        <div className="flex m-auto w-[1002.34px] h-[301.68px] justify-around items-center mb-[33.41px]">
            ...
            <div className="w-[561px] h-full mt-[75px]">
                ...
                <a href="https://youtu.be/V3e8oP21xik?si=EvFNM6__i5F2p2Ev" target='_blank' className="py-[14px] px-[38px] text-white bg-goodgreen hover:bg-bestgreen rounded font-medium text-xs">Learn More</a>
            </div>
        </div>
    );
}
