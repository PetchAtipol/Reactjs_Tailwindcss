            ...
            <div className="w-full h-[229.21px] bg-D_black flex justify-around items-center">
                ...
                <div className="w-[442px] h-[140.12px] flex justify-around">
                    <div className="flex flex-col w-[111.37px] h-[140.12px]">
                        ...
                        <a href="https://www.youtube.com/@ShishiroBotan" target="_blank" className="text-white text-[9.74px] mb-[10px] hover:text-goodgreen">About us</a>
                        <a href="https://youtu.be/fShlVhCfHig?si=dGNlSBoiJbuR56pk" target="_blank" className="text-white text-[9.74px] mb-[10px] hover:text-goodgreen">Blog</a>
                        <a href="https://www.youtube.com/@ShishiroBotan" target="_blank" className="text-white text-[9.74px] mb-[10px] hover:text-goodgreen">Contact us</a>
                        <a href="https://www.youtube.com/@ShishiroBotan" target="_blank" className="text-white text-[9.74px] mb-[10px] hover:text-goodgreen">Pricing</a>
                        <a href="https://www.youtube.com/@ShishiroBotan" target="_blank" className="text-white text-[9.74px] hover:text-goodgreen">Testimonials</a>
                    </div>
                    <div className="flex flex-col w-[111.37px] h-[140.12px]">
